                ...
                <main className="flex-grow flex items-center justify-center">
                    <div className="container mx-auto">
                        <div className="grid lg:grid-cols-2 gap-8 items-center">
                            ...
                            <div className="flex justify-center items-center py-12 lg:py-0 mt-4 mb-4">
                                <div className="rounded-2xl p-10 w-full max-w-lg bg-white dark:bg-gray-800 shadow-xl">
                                    ...
                                    <form className="space-y-6" onSubmit={handleSubmit}>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center">
                                                ...
                                                <span
                                                    className="w-4 h-4 bg-transparent text-black dark:text-white border border-black dark:border-white rounded-full flex items-center justify-center text-xs font-bold cursor-default">
                                                    i
                                                </span>
                                                    <div
                                                        className="absolute bottom-full mb-2 w-64 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none bg-gray-800 text-white text-xs rounded py-2 px-3 shadow-lg">
                                                        {t("profile.country_info") || "Especificar el país es esencial para poder obtener la ropa disponible en tu país y brindar al usuario una mejor experiencia."}
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label htmlFor="terms" className="ml-2 block text-sm text-gray-900 dark:text-gray-200">
                                                    ...
                                                    <Link href="/terms&conditions" legacyBehavior>
                                                        <a className="underline text-blue-600 dark:text-blue-400 cursor-pointer">
                                                            {t("termsLink")}
                                                        </a>
                                                    </Link>
                                                </label>
