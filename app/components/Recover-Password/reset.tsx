    ...
    const handleEmailSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setError(errorData.message || t("reset.errorEmail"));
            }
        } catch (err) {
            console.error(err);
    ...
    const handleResendCode = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorData = await response.json();
                setError(errorData.message || t("reset.errorResend"));
            }
        } catch (err) {
            console.error(err);
            setError(t("reset.serverError"));
    ...
    const handleCodeSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorData = await response.json();
                setError(errorData.message || t("reset.invalidCode"));
            }
        } catch (err) {
            console.error(err);
            setError(t("reset.serverError"));
